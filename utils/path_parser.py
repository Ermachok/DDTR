...
def read_config(config_path: Path):
    ...
    path_calib_data = config.get("Paths", "path_calib_data")
    path_experimental_data = config.get("Paths", "path_experimental_data")
    path_ophir_exper = config.get("Paths", "path_ophir_experimental")
    path_ophir_calib = config.get("Paths", "path_ophir_calibration")
    ...
    config_data = {
        "path_calib_data": Path(path_calib_data),
        "path_experimental_data": Path(path_experimental_data),
        "path_ophir_experimental": Path(path_ophir_exper),
        "path_ophir_calibration": Path(path_ophir_calib),
        "ophir_shot_name_end": Path(ophir_shot_name_end),
        "sht_files_path": Path(sht_files_path),
        "path_spectral_calibration": os.path.join(
            path_spectral_calibration, spec_calib_filename
        ),
        "path_absolute_calibration": os.path.join(
            path_absolute_calibration, abs_calib_filename
        ),
