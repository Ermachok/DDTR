...
def caen_msg_handler(path, t_step=0.325, time_shift=100, processed_shots: int | str = 30):
    """
...
def handle_all_caens(discharge_num: str, path: str, processed_shots: int | str) -> (list, list):
    ...
    return {'combiscope_times': combiscope_times,
            'caens_data': all_caens}
...
if __name__ == '__main__':
    for i in range(10):
        ...
        all_caens = handle_all_caens(discharge_num=discharge_number, path=path_data, processed_shots=30)
        msg_list = [0, 1, 2, 3]
